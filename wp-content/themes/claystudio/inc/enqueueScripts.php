...
function claystudio_enqueue_scripts()
{
    ...
    wp_enqueue_style('claystudio-inner-content', get_template_directory_uri() . '/assets/css/inner-content.css', array(), filemtime(get_template_directory() . '/assets/css/inner-content.css'), 'all');
    wp_enqueue_style('claystudio-inner-content2', get_template_directory_uri() . '/assets/css/inner-content-2.css', array(), filemtime(get_template_directory() . '/assets/css/inner-content-2.css'), 'all');
    wp_enqueue_style('claystudio-sub-page', get_template_directory_uri() . '/assets/css/sub-page.css', array(), filemtime(get_template_directory() . '/assets/css/sub-page.css'), 'all');
    ...
    wp_enqueue_script('claystudio-splide-extension-auto-scroll-min', get_template_directory_uri() . '/assets/js/splide-extension-auto-scroll.min.js', array(), filemtime(get_template_directory() . '/assets/js/splide-extension-auto-scroll.min.js'), true);
    wp_enqueue_script('claystudio-js', get_template_directory_uri() . '/assets/js/main.js', array('jquery'), time(), true);
    wp_enqueue_script('claystudio-slider', get_template_directory_uri() . '/assets/js/slider.js', array(), filemtime(get_template_directory() . '/assets/js/slider.js'), true);
    wp_enqueue_script('claystudio-tab', get_template_directory_uri() . '/assets/js/tab.js', array(), filemtime(get_template_directory() . '/assets/js/tab.js'), true);
    wp_enqueue_script('claystudio-inner', get_template_directory_uri() . '/assets/js/inner.js', array(), filemtime(get_template_directory() . '/assets/js/inner.js'), true);
    wp_enqueue_script('claystudio-popups', get_template_directory_uri() . '/assets/js/popups.js', array(), filemtime(get_template_directory() . '/assets/js/popups.js'), true);
    wp_localize_script('claystudio-js', 'ajax_object', array('ajax_url' => admin_url('admin-ajax.php')));
}
