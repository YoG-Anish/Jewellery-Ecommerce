...
function claystudio_enqueue_scripts() {
    ...
    wp_enqueue_style('claystudio-inner-content2', get_template_directory_uri() . '/assets/css/inner-content-2.css', array(), '1.0', 'all');
    ...
    wp_enqueue_script('claystudio-tab', get_template_directory_uri() . '/assets/js/tab.js', array(), '1.0', true);
}
