      ...
      <div class="container support-content">
        ...
        <section>
          ...
          <p>
            ...
            <span class="shipping-link">free shipping</span> on all UK
            orders.
          </p>
          <p>Orders will be processed within 2 - 4 working days.</p>
        </section>

        <section>
          <h2>Returns</h2>
          <p>
            Unfortunately, due to hygiene reasons I am unable to accept
            returns.
          </p>
          <p>
            However, if the earrings are damaged due to faults in the
            design, please contact me and a replacement can be arranged. We
            have a 30-day return policy, which means you have 30 days after
