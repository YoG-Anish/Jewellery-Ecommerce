                ...
                <div class="wpc-pro-bnf-wrap">
                    <section class="wpc-pro-bnf-sect-1">
                        ...
                        <div class="wpc-pro-bnf-sect-1-btns-wrap">
                            <a href="<?php echo esc_url(flrt_unlock_pro_link('features_view_link')) ?>" target="_blank" class="wpc-pro-bnf-sect-1-btns-up-to-pro"><?php echo _x('Upgrade to PRO', 'benefits-landing', 'filter-everything'); ?></a>
                        ...
                        <div class="fetm-freevspro-wrap">
                            ...
                            <div class="fetm-freevspro-bottom">
                                ...
                                <div class="fetm-freevspro-links">
                                    <a href="<?php echo esc_url(flrt_unlock_pro_link('compare_buy_btn')) ?>" target="_blank" class="wpc-pro-bnf-sect-1-btns-up-to-pro"><?php echo _x('Buy PRO', 'benefits-landing', 'filter-everything'); ?></a>
                                </div>
                            </div>
                    ...
                    <section class="wpc-pro-bnf-sect-8">
                        <div class="wpc-pro-bnf-sect-8-left-wrap">
                            ...
                            <a href="<?php echo esc_url(flrt_unlock_pro_link('footer_upgrade_btn')) ?>" target="_blank" class="wpc-pro-bnf-sect-1-btns-up-to-pro"><?php echo _x('Upgrade to PRO', 'benefits-landing', 'filter-everything'); ?></a>
                        </div>
