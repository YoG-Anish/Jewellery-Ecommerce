...
class AdminHooks
{
    ...
    public function aboutPro()
    {
        if ( ! defined('FLRT_FILTERS_PRO') ) {
            ...
            echo '<a class="wpc-tab wpc-get-pro wpc-get-pro-background button button-primary" href="'. esc_url(flrt_unlock_pro_link( 'hero_upgrade_btn' )).'" target="_blank">'.esc_html__( 'Upgrade to PRO', 'filter-everything' ).'</a>'."\r\n";
        }
